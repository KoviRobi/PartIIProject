...
public abstract class NullaryOrUnaryLambda extends LambdaValue
{ @Override
  ...
  { int length = 0;
    ...
    { throw new IllegalArgumentException(this.getClass().getName() + " is expecting zero or one RuntimeValue arguments, got " + arguments);
    }
  }
